...
var process = new (system.v8cgi.require('process').Process)();
...
exports.isLink = function (path) {
    // FIXME hack
    return process.exec("bash -c 'if [ -L " + path + " ]; then echo '1'; else echo '0'; fi'") == 1;
};
